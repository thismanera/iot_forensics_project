...
"""
=============================================================================
Network Forensics Project — Scenario 5: Botnet DDoS Attack
=============================================================================
Timeline:
...
DEFAULT_PCAP_PATH    = "pcaps/originals/scenario5_botnet_ddos.pcap"
CAMERA_PORT          = 50005        
MQTT_PORT            = 8883         
NTP_PORT             = 123          
DNS_PORT             = 53           
...
# ---------------------------------------------------------------------------
# Attack functions for Scenario 5
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
def parse_args():
    parser = argparse.ArgumentParser(description="Scenario 5 — Botnet DDoS Attack")
...
def run_scenario(args):
    setLogLevel("info")
    info("=" * 70 + "\n")
    info(" Scenario 5 — Botnet DDoS Attack\n")
    info("=" * 70 + "\n")
        ...
        try:
            ...
            while True:
                ...
                if elapsed != last_reported and elapsed % 10 == 0:
                    info(f"    [{elapsed:4d}/{args.duration}s] Scenario 5 running\n")

...
In strict adherence to the defined forensic methodology (Phase 1), the integrity of the original network capture must be cryptographically verified before any analysis occurs. Following the 60-minute baseline simulation, the raw traffic was exported as \texttt{scenario1\_baseline.pcap}. 

...
\begin{figure}[H]
	...
	\caption{Scenario 1: Terminal execution demonstrating the SHA-256 hashing and working copy verification.}
...
\begin{figure}[H]
	...
	\caption{Scenario 1: Zeek log extraction of Scenario 1.}
...
\begin{figure}[H]
	...
	\caption{Scenario 1: Smart Camera Bandwidth evolution over experiment time.}
...
\begin{figure}[H]
	...
	\caption{Scenario 1: IAT of Smart Thermostat Keep Alive messages.}
...
\begin{figure}[H]
	...
	\caption{Scenario 1: Empirical interaction heatmap detailing authorized internal network flows.}
	\label{fig:topologytrafficmatrix1}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Scenario 1: TCP Connection State Distribution.}
	\label{fig:tcpconnectionstates1}
\end{figure}

...
\begin{figure}
	...
	\caption{Scenario3: Throughput change of destination without bandwidth alteration.}
...
\begin{figure}[H]
	...
	\caption{Empirical interaction heatmap detailing authorized internal network flows (Scenario 3).}

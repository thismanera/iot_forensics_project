...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth]{../figures/scenario3/tcp_connection_states}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth]{../figures/scenario3/topology_traffic_matrix}
